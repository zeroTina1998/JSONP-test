...
var server = http.createServer(function (request, response) {
  ...
  if (path === "/index.html") {
    ...
    response.write(fs.readFileSync("qq-com/public/friend.json"));
    response.end();
  } else if (path === "/friend.js") {
    response.statusCode = 200;
    response.setHeader("Content-Type", "text/javascript;charset=utf-8");
    response.setHeader("Access-Control-Allow-Origin", "http://frank.com:9999");
    const string = fs.readFileSync("qq-com/public/friend.js").toString();
    const data = fs.readFileSync("qq-com/public/friend.json").toString();
